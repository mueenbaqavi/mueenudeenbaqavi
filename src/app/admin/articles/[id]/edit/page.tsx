...
import { getAdminArticleForEdit, listCategories, listAuthors } from "@/lib/admin-content-repository";
  ...
  return (
    <>
      ...
      <section className="container py-10">
        <ContentEditorForm action={updateArticleAction} initialValue={article} kind="article" categories={categories} authors={authors} />
      </section>
    </>
  );
}
