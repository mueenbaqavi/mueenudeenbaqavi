...
import { listCategories } from "@/lib/admin-content-repository";
...
export default async function NewFatwaPage() {
  const categories = await listCategories("fatwa");
  ...
  return (
    <>
      ...
      <section className="container py-10">
        <ContentEditorForm action={createFatwaAction} kind="fatwa" categories={categories} />
      </section>
    </>
  );
}
